...
export default {
  ...
  "st.display.help_improve.desc_html": "Autorise la conservation de certaines interactions WebBrain Compass et leur utilisation pour l’évaluation, l’amélioration, l’ajustement fin et l’entraînement. Activé par défaut. Désactivez cette option pour empêcher que les futures interactions Compass soient utilisées à ces fins. <u>Local-model and bring-your-own API requests are only collected by WebBrain from providers where you turn on “Share queries for research”.</u> <a href=\"https://webbrain.one/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:var(--accent);\">Politique de confidentialité →</a>",
  "st.providers.webbrain_data_use.body": "Une utilisation quotidienne gratuite de WebBrain Compass est incluse. Tant que Aider à améliorer WebBrain est activé par défaut, certaines conversations Compass peuvent être conservées et utilisées pour l’évaluation, l’amélioration, l’ajustement fin et l’entraînement. Désactivez cette option dans Général → Avancé pour exclure les futures interactions Compass de ces usages. <u>Local-model and bring-your-own API requests are only collected by WebBrain when you turn on the per-provider “Share queries for research” option.</u> {privacyLink}. Pour davantage d’utilisation, abonnez-vous sur {subscribeLink}. Gérez la facturation sur {accountLink}.",
