...
export default {
  ...
  "st.display.help_improve.desc_html": "السماح بالاحتفاظ بتفاعلات محددة مع WebBrain Compass واستخدامها للتقييم والتحسين والضبط الدقيق والتدريب. مفعّل افتراضيًا. عطّله لمنع استخدام تفاعلات Compass المستقبلية لهذه الأغراض. <u>Local-model and bring-your-own API requests are only collected by WebBrain from providers where you turn on “Share queries for research”.</u> <a href=\"https://webbrain.one/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:var(--accent);\">سياسة الخصوصية →</a>",
  "st.providers.webbrain_data_use.body": "يتضمن WebBrain Compass استخدامًا يوميًا مجانيًا. عندما تكون «المساعدة في تحسين WebBrain» مفعّلة افتراضيًا، قد يتم الاحتفاظ بمحادثات Compass محددة واستخدامها للتقييم والتحسين والضبط الدقيق والتدريب. عطّلها من عام ← متقدم لاستبعاد تفاعلات Compass المستقبلية من هذه الاستخدامات. <u>Local-model and bring-your-own API requests are only collected by WebBrain when you turn on the per-provider “Share queries for research” option.</u> {privacyLink}. لمزيد من الاستخدام، اشترك عبر {subscribeLink}. أدِر الفوترة عبر {accountLink}.",
