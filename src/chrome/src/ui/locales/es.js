...
export default {
  ...
  "st.display.help_improve.desc_html": "Permite conservar determinadas interacciones de WebBrain Compass y utilizarlas para evaluación, mejora, ajuste fino y entrenamiento. Activado de forma predeterminada. Desactívalo para impedir que futuras interacciones de Compass se utilicen con esos fines. <u>Local-model and bring-your-own API requests are only collected by WebBrain from providers where you turn on “Share queries for research”.</u> <a href=\"https://webbrain.one/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:var(--accent);\">Política de privacidad →</a>",
  "st.providers.webbrain_data_use.body": "Se incluye uso diario gratuito de WebBrain Compass. Mientras Ayuda a mejorar WebBrain está activado de forma predeterminada, algunas conversaciones de Compass pueden conservarse y utilizarse para evaluación, mejora, ajuste fino y entrenamiento. Desactívalo en General → Avanzado para excluir futuras interacciones de Compass de esos usos. <u>Local-model and bring-your-own API requests are only collected by WebBrain when you turn on the per-provider “Share queries for research” option.</u> {privacyLink}. Para obtener más uso, suscríbete en {subscribeLink}. Gestiona la facturación en {accountLink}.",
