...
export default {
  ...
  "st.display.help_improve.desc_html": "Izinkan interaksi WebBrain Compass tertentu disimpan dan digunakan untuk evaluasi, peningkatan, penyempurnaan, dan pelatihan. Aktif secara default. Nonaktifkan agar interaksi Compass mendatang tidak digunakan untuk tujuan tersebut. <u>Local-model and bring-your-own API requests are only collected by WebBrain from providers where you turn on “Share queries for research”.</u> <a href=\"https://webbrain.one/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:var(--accent);\">Kebijakan privasi →</a>",
  "st.providers.webbrain_data_use.body": "Penggunaan harian gratis WebBrain Compass sudah termasuk. Saat Bantu Tingkatkan WebBrain aktif secara default, percakapan Compass tertentu dapat disimpan dan digunakan untuk evaluasi, peningkatan, penyempurnaan, dan pelatihan. Nonaktifkan di Umum → Lanjutan agar interaksi Compass mendatang tidak digunakan untuk tujuan tersebut. <u>Local-model and bring-your-own API requests are only collected by WebBrain when you turn on the per-provider “Share queries for research” option.</u> {privacyLink}. Untuk penggunaan lebih banyak, berlangganan di {subscribeLink}. Kelola penagihan di {accountLink}.",
