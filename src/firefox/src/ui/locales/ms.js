...
export default {
  ...
  "st.display.help_improve.desc_html": "Benarkan interaksi WebBrain Compass terpilih disimpan dan digunakan untuk penilaian, penambahbaikan, penalaan halus dan latihan. Dihidupkan secara lalai. Matikan untuk menghalang interaksi Compass pada masa hadapan daripada digunakan bagi tujuan tersebut. <u>Local-model and bring-your-own API requests are only collected by WebBrain from providers where you turn on “Share queries for research”.</u> <a href=\"https://webbrain.one/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:var(--accent);\">Dasar privasi →</a>",
  "st.providers.webbrain_data_use.body": "Penggunaan harian percuma WebBrain Compass disertakan. Semasa Bantu Tingkatkan WebBrain dihidupkan secara lalai, perbualan Compass terpilih mungkin disimpan dan digunakan untuk penilaian, penambahbaikan, penalaan halus dan latihan. Matikan di Umum → Lanjutan untuk mengecualikan interaksi Compass pada masa hadapan daripada penggunaan tersebut. <u>Local-model and bring-your-own API requests are only collected by WebBrain when you turn on the per-provider “Share queries for research” option.</u> {privacyLink}. Untuk penggunaan tambahan, langgan di {subscribeLink}. Urus pengebilan di {accountLink}.",
